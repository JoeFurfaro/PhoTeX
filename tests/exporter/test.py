...
rect1 = Rect(True, Vector2(-125, 0), 250, 500, stroke=Stroke('black', 5, 1), fill=Fill("white", 1), children=[], rotation=0)
rect2 = Rect(False, Vector2(125, 0), 250, 500, stroke=Stroke('white', 5, 1), fill=Fill("black", 1), children=[], rotation=0)
